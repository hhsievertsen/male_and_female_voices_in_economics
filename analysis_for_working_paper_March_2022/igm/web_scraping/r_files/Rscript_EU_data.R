setwd ("C:\\Users\\hs17922\\Dropbox\\Work\\Research\\Projects\\14 igm\\analysis\\igm\\data")
library("tidyverse")
library("readxl")
library("readstata13")
library(stringr)
rm(list=ls())
# load data
df<-read_delim("data_scraped//data_output_EU.csv",delim="|")
# Confidence
...
# write to Stata
save.dta13(df_m,"data_scraped/cleaned_data_EU.dta")
